...
--
-- Host: localhost    Database: emailmarketing
-- ------------------------------------------------------
...
--
-- Temporary table structure for view `email_cad`
--

DROP TABLE IF EXISTS `email_cad`;
/*!50001 DROP VIEW IF EXISTS `email_cad`*/;
...
--
-- Final view structure for view `email_cad`
--
